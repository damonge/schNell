...
plt.figure()
plt.plot(ls[::2], (ls*(ls+1)*nl_I_I/(2*np.pi))[::2], 'ro--', label='I,I')
plt.plot(ls[::2], (ls*(ls+1)*nl_II_II/(2*np.pi))[::2], 'rv-.', label='II,II')
plt.plot(ls[::2], (ls*(ls+1)*nl_I_II/(2*np.pi))[::2], 'rd:', label='I,II')
plt.plot(ls[::2], (ls*(ls+1)*nl_I_II_sum/(2*np.pi))[::2], 'rx-', label='I,II - comb')
plt.xlim([1, 60])
...
plt.figure()
plt.plot(ls[::2], (ls*(ls+1)*nl_p_p/(2*np.pi))[::2], 'bo--', label='+,+')
plt.plot(ls[::2], (ls*(ls+1)*nl_m_m/(2*np.pi))[::2], 'bv-.', label='-,-')
plt.plot(ls[::2], (ls*(ls+1)*nl_p_m/(2*np.pi))[::2], 'bd:', label='+,-')
plt.plot(ls[::2], (ls*(ls+1)*nl_p_m_sum/(2*np.pi))[::2], 'bx-', label='+,- - comb')
plt.xlim([1, 60])
plt.ylim([2E-27, 6E-11])
plt.xlabel(r'$\ell$', fontsize=16)
plt.ylabel(r'$\ell(\ell+1)N_\ell/2\pi$', fontsize=16)
