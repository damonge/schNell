...
det_0b = LISADetector(0, map_transfer=True, is_L5Gm=True)
det_1 = LISADetector(1, map_transfer=True)
mc = MapCalculator(det_0, det_1, f_pivot=1E-2)
mcb = MapCalculator(det_0b, det_0b, f_pivot=1E-2)
...
for i, f in enumerate([0.001, 0.01, 0.1, 0.2]):
    resp_pp = mcb.get_gamma(0., f, theta, phi, inc_baseline=True, typ='+,+')
